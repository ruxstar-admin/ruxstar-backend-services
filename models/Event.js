...
const sanitize = (doc) => {
  ...
  return {
    ...
    minCapacity: typeof doc.minCapacity === 'number' ? doc.minCapacity : null,
    capacity,
    ...
    venue: doc.venue ?? '',
    venueLat: typeof doc.venueLat === 'number' ? doc.venueLat : null,
    venueLng: typeof doc.venueLng === 'number' ? doc.venueLng : null,
    ...
    gstPercentage: typeof doc.gstPercentage === 'number' ? doc.gstPercentage : null,
...
const insert = async (vendorId, data) => {
  ...
  const doc = {
    ...
    minCapacity: typeof data.minCapacity === 'number' ? data.minCapacity : null,
    ...
    currency: 'INR',
    venue: data.venue ?? '',
    venueLat: typeof data.venueLat === 'number' ? data.venueLat : null,
    venueLng: typeof data.venueLng === 'number' ? data.venueLng : null,
    ...
    gstPercentage: typeof data.gstPercentage === 'number' ? data.gstPercentage : null,
